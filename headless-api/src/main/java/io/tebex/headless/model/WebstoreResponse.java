...
public class WebstoreResponse {
  ...
  public WebstoreResponse data(@javax.annotation.Nullable Webstore data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Webstore data) {
    this.data = data;
  }
   ...
   * @return the WebstoreResponse instance itself
   */
  public WebstoreResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, webstoreResponse.data)&&
        Objects.equals(this.additionalProperties, webstoreResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebstoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebstoreResponse is not found in the empty JSON string", WebstoreResponse.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Webstore.validateJsonElement(jsonObj.get("data"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebstoreResponse>() {
           ...
           public WebstoreResponse read(JsonReader in) throws IOException {
             ...
             WebstoreResponse instance = thisAdapter.fromJsonTree(jsonObj);
