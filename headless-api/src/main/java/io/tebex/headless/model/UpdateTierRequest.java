...
public class UpdateTierRequest {
  ...
  public UpdateTierRequest packageId(@javax.annotation.Nullable Integer packageId) {
  ...
  public void setPackageId(@javax.annotation.Nullable Integer packageId) {
    this.packageId = packageId;
  }
   ...
   * @return the UpdateTierRequest instance itself
   */
  public UpdateTierRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.packageId, updateTierRequest.packageId)&&
        Objects.equals(this.additionalProperties, updateTierRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateTierRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateTierRequest is not found in the empty JSON string", UpdateTierRequest.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateTierRequest>() {
           ...
           public UpdateTierRequest read(JsonReader in) throws IOException {
             ...
             UpdateTierRequest instance = thisAdapter.fromJsonTree(jsonObj);
