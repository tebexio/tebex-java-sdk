...
public class GiftCard {
   ...
   * @return the GiftCard instance itself
   */
  public GiftCard putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cardNumber, giftCard.cardNumber)&&
        Objects.equals(this.additionalProperties, giftCard.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GiftCard>() {
           ...
           public GiftCard read(JsonReader in) throws IOException {
             ...
             GiftCard instance = thisAdapter.fromJsonTree(jsonObj);
