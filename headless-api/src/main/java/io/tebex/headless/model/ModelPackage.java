...
public class ModelPackage {
  ...
  public ModelPackage ident(@javax.annotation.Nullable String ident) {
    this.ident = ident;
    return this;
  }
  ...
  public ModelPackage vipStatus(@javax.annotation.Nullable String vipStatus) {
  ...
  public void setVipStatus(@javax.annotation.Nullable String vipStatus) {
    this.vipStatus = vipStatus;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, image, type, category, basePrice, salesTax, totalPrice, currency, proratePrice, discount, disableQuantity, disableGifting, expirationDate, media, order, slug, userLimit, creatorMetaData, options, variables, createdAt, updatedAt, ident, vipStatus, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "description", "image", "type", "category", "base_price", "sales_tax", "total_price", "currency", "prorate_price", "discount", "disable_quantity", "disable_gifting", "expiration_date", "media", "order", "slug", "user_limit", "creator_meta_data", "options", "variables", "created_at", "updated_at", "ident", "vip_status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("vip_status") != null && !jsonObj.get("vip_status").isJsonNull()) && !jsonObj.get("vip_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `vip_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("vip_status").toString()));
      }
  }
