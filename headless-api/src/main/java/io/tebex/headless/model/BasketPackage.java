...
public class BasketPackage {
  ...
  public BasketPackage isRecurring(@javax.annotation.Nullable Boolean isRecurring) {
  ...
  public void setIsRecurring(@javax.annotation.Nullable Boolean isRecurring) {
    this.isRecurring = isRecurring;
  }
   ...
   * @return the BasketPackage instance itself
   */
  public BasketPackage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, basketPackage.id) &&
        ...
        Objects.equals(this.additionalProperties, basketPackage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, image, name, slug, inBasket, type, revenueShare, isRecurring, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "description", "image", "name", "slug", "in_basket", "type", "revenue_share", "is_recurring"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasketPackage>() {
           ...
           public BasketPackage read(JsonReader in) throws IOException {
             ...
             BasketPackage instance = thisAdapter.fromJsonTree(jsonObj);
