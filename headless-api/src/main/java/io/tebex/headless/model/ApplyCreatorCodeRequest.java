...
public class ApplyCreatorCodeRequest {
  ...
  public ApplyCreatorCodeRequest creatorCode(@javax.annotation.Nullable String creatorCode) {
   ...
   * @return the ApplyCreatorCodeRequest instance itself
   */
  public ApplyCreatorCodeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creatorCode, applyCreatorCodeRequest.creatorCode)&&
        Objects.equals(this.additionalProperties, applyCreatorCodeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creatorCode, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("creator_code"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplyCreatorCodeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplyCreatorCodeRequest is not found in the empty JSON string", ApplyCreatorCodeRequest.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ApplyCreatorCodeRequest>() {
           ...
           public ApplyCreatorCodeRequest read(JsonReader in) throws IOException {
             ...
             ApplyCreatorCodeRequest instance = thisAdapter.fromJsonTree(jsonObj);
