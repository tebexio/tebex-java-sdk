...
public class Basket {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, ident, complete, email, username, coupons, giftcards, creatorCode, cancelUrl, completeUrl, completeAutoRedirect, country, ip, usernameId, basePrice, salesTax, totalPrice, currency, packages, custom, links, additionalProperties);
  }
