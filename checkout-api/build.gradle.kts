// Build script for the generated Tebex Checkout API Java SDK.
//
// The Java SOURCES under src/ are produced by the OpenAPI generator — never edit
// them by hand; run `docker compose run --rm checkout-api-generator` to
// regenerate them from ../apis/checkout-api.yaml. This build script, and the
...
// `./gradlew :checkout-api:javadoc` usable for local inspection regardless — safe
