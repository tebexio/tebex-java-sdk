...
public class UpdateRecurringPaymentRequest {
  ...
  public UpdateRecurringPaymentRequest status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateRecurringPaymentRequest pausedUntil(@javax.annotation.Nullable String pausedUntil) {
  ...
  public void setPausedUntil(@javax.annotation.Nullable String pausedUntil) {
    this.pausedUntil = pausedUntil;
  }
   ...
   * @return the UpdateRecurringPaymentRequest instance itself
   */
  public UpdateRecurringPaymentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, updateRecurringPaymentRequest.status) &&
        ...
        Objects.equals(this.additionalProperties, updateRecurringPaymentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, pausedUntil, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "paused_until"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRecurringPaymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateRecurringPaymentRequest is not found in the empty JSON string", UpdateRecurringPaymentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("paused_until") != null && !jsonObj.get("paused_until").isJsonNull()) && !jsonObj.get("paused_until").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `paused_until` to be a primitive type in the JSON string but got `%s`", jsonObj.get("paused_until").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateRecurringPaymentRequest>() {
           ...
           public UpdateRecurringPaymentRequest read(JsonReader in) throws IOException {
             ...
             UpdateRecurringPaymentRequest instance = thisAdapter.fromJsonTree(jsonObj);
