...
public class RecurringPaymentSubject {
   ...
   * @return the RecurringPaymentSubject instance itself
   */
  public RecurringPaymentSubject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reference, recurringPaymentSubject.reference) &&
        ...
        Objects.equals(this.additionalProperties, recurringPaymentSubject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(reference, createdAt, pausedAt, pausedUntil, nextPaymentAt, status, initialPayment, lastPayment, failCount, price, cancelledAt, cancelReason, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecurringPaymentSubject>() {
           ...
           public RecurringPaymentSubject read(JsonReader in) throws IOException {
             ...
             RecurringPaymentSubject instance = thisAdapter.fromJsonTree(jsonObj);
