...
public class BasketRow {
   ...
   * @return the BasketRow instance itself
   */
  public BasketRow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, basketRow.id) &&
        ...
        Objects.equals(this.additionalProperties, basketRow.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, basket, _package, override, quantity, server, price, giftUsernameId, options, recurring, recurringPeriod, recurringNextPaymentDate, meta, custom, imageUrl, recurringPrice, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasketRow>() {
           ...
           public BasketRow read(JsonReader in) throws IOException {
             ...
             BasketRow instance = thisAdapter.fromJsonTree(jsonObj);
