...
public class Payment {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionId, status, paymentSequence, createdAt, price, pricePaid, paymentMethod, revenueShare, declineReason, fees, customer, products, coupons, giftCards, recurringPaymentReference, custom, additionalProperties);
  }
