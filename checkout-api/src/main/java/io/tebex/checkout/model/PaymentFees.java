...
import io.tebex.checkout.model.PaymentFeesGateway;
...
public class PaymentFees {
  ...
  public PaymentFees tax(@javax.annotation.Nullable PaymentFeesTax tax) {
    this.tax = tax;
    return this;
  }
  ...
  public void setTax(@javax.annotation.Nullable PaymentFeesTax tax) {
    this.tax = tax;
  }


  public PaymentFees gateway(@javax.annotation.Nullable PaymentFeesGateway gateway) {
  ...
  public void setGateway(@javax.annotation.Nullable PaymentFeesGateway gateway) {
    this.gateway = gateway;
  }
   ...
   * @return the PaymentFees instance itself
   */
  public PaymentFees putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tax, paymentFees.tax) &&
        ...
        Objects.equals(this.additionalProperties, paymentFees.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentFees.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaymentFees is not found in the empty JSON string", PaymentFees.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentFees>() {
           ...
           public PaymentFees read(JsonReader in) throws IOException {
             ...
             PaymentFees instance = thisAdapter.fromJsonTree(jsonObj);
