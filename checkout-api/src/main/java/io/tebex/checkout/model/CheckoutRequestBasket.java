...
public class CheckoutRequestBasket {
  ...
  public CheckoutRequestBasket firstName(@javax.annotation.Nullable String firstName) {
  ...
  public CheckoutRequestBasket lastName(@javax.annotation.Nullable String lastName) {
  ...
  public CheckoutRequestBasket email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public CheckoutRequestBasket returnUrl(@javax.annotation.Nullable String returnUrl) {
  ...
  public CheckoutRequestBasket completeUrl(@javax.annotation.Nullable String completeUrl) {
  ...
  public CheckoutRequestBasket custom(@javax.annotation.Nullable Object custom) {
    this.custom = custom;
    return this;
  }
   ...
   * @return the CheckoutRequestBasket instance itself
   */
  public CheckoutRequestBasket putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstName, checkoutRequestBasket.firstName) &&
        ...
        Objects.equals(this.additionalProperties, checkoutRequestBasket.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, email, returnUrl, completeUrl, custom, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("first_name", "last_name", "email", "return_url", "complete_url", "custom"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckoutRequestBasket.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CheckoutRequestBasket is not found in the empty JSON string", CheckoutRequestBasket.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CheckoutRequestBasket>() {
           ...
           public CheckoutRequestBasket read(JsonReader in) throws IOException {
             ...
             CheckoutRequestBasket instance = thisAdapter.fromJsonTree(jsonObj);
