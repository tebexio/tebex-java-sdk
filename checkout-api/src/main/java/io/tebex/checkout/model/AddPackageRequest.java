...
public class AddPackageRequest {
  ...
  public AddPackageRequest _package(@javax.annotation.Nullable ModelPackage _package) {
  ...
  public AddPackageRequest qty(@javax.annotation.Nullable Integer qty) {
    this.qty = qty;
    return this;
  }
  ...
  public AddPackageRequest type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AddPackageRequest revenueShare(@javax.annotation.Nullable List<RevenueShare> revenueShare) {
   ...
   * @return the AddPackageRequest instance itself
   */
  public AddPackageRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._package, addPackageRequest._package) &&
        ...
        Objects.equals(this.additionalProperties, addPackageRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_package, qty, type, revenueShare, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("package", "qty", "type", "revenue_share"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddPackageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddPackageRequest is not found in the empty JSON string", AddPackageRequest.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddPackageRequest>() {
           ...
           public AddPackageRequest read(JsonReader in) throws IOException {
             ...
             AddPackageRequest instance = thisAdapter.fromJsonTree(jsonObj);
