...
public class Address {
  ...
  public Address firstName(@javax.annotation.Nullable String firstName) {
  ...
  public Address lastName(@javax.annotation.Nullable String lastName) {
  ...
  public Address stateId(@javax.annotation.Nullable String stateId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, firstName, lastName, address, email, stateId, country, postalCode, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "first_name", "last_name", "address", "email", "state_id", "country", "postal_code"));
