...
public class PaymentProductsInnerPaidPrice {
  ...
  public PaymentProductsInnerPaidPrice amount(@javax.annotation.Nullable Float amount) {
    this.amount = amount;
    return this;
  }
  ...
  public PaymentProductsInnerPaidPrice currency(@javax.annotation.Nullable String currency) {
   ...
   * @return the PaymentProductsInnerPaidPrice instance itself
   */
  public PaymentProductsInnerPaidPrice putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, paymentProductsInnerPaidPrice.amount) &&
        ...
        Objects.equals(this.additionalProperties, paymentProductsInnerPaidPrice.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentProductsInnerPaidPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaymentProductsInnerPaidPrice is not found in the empty JSON string", PaymentProductsInnerPaidPrice.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PaymentProductsInnerPaidPrice>() {
           ...
           public PaymentProductsInnerPaidPrice read(JsonReader in) throws IOException {
             ...
             PaymentProductsInnerPaidPrice instance = thisAdapter.fromJsonTree(jsonObj);
