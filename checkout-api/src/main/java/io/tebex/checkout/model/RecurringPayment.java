...
public class RecurringPayment {
   ...
   * @return the RecurringPayment instance itself
   */
  public RecurringPayment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, recurringPayment.id) &&
        ...
        Objects.equals(this.additionalProperties, recurringPayment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdAt, updatedAt, pausedAt, pausedUntil, nextPaymentDate, reference, accountId, interval, cancelledAt, cancellationRequestedAt, status, amount, cancelReason, links, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecurringPayment>() {
           ...
           public RecurringPayment read(JsonReader in) throws IOException {
             ...
             RecurringPayment instance = thisAdapter.fromJsonTree(jsonObj);
