...
public class RecurringPaymentLinks {
  ...
  public RecurringPaymentLinks initialPayment(@javax.annotation.Nullable String initialPayment) {
  ...
  public void setInitialPayment(@javax.annotation.Nullable String initialPayment) {
    this.initialPayment = initialPayment;
  }


  public RecurringPaymentLinks paymentHistory(@javax.annotation.Nullable List<String> paymentHistory) {
  ...
  public void setPaymentHistory(@javax.annotation.Nullable List<String> paymentHistory) {
    this.paymentHistory = paymentHistory;
  }
   ...
   * @return the RecurringPaymentLinks instance itself
   */
  public RecurringPaymentLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.initialPayment, recurringPaymentLinks.initialPayment) &&
        ...
        Objects.equals(this.additionalProperties, recurringPaymentLinks.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(initialPayment, paymentHistory, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("initial_payment", "payment_history"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RecurringPaymentLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RecurringPaymentLinks is not found in the empty JSON string", RecurringPaymentLinks.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("initial_payment") != null && !jsonObj.get("initial_payment").isJsonNull()) && !jsonObj.get("initial_payment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `initial_payment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("initial_payment").toString()));
      }
      ...
      if (jsonObj.get("payment_history") != null && !jsonObj.get("payment_history").isJsonNull() && !jsonObj.get("payment_history").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `payment_history` to be an array in the JSON string but got `%s`", jsonObj.get("payment_history").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecurringPaymentLinks>() {
           ...
           public RecurringPaymentLinks read(JsonReader in) throws IOException {
             ...
             RecurringPaymentLinks instance = thisAdapter.fromJsonTree(jsonObj);
